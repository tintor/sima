...
inline double22 transpose(double22 m) { return {{m.a.x, m.b.x}, {m.a.y, m.b.y}}; }

inline double33 transpose(double33 m) { return {{m.a.x, m.b.x, m.c.x}, {m.a.y, m.b.y, m.c.y}, {m.a.z, m.b.z, m.c.z}}; }
...
inline double44 inv(double44 m) {
    ...
    res.a.x = m.b.y * m.c.z * m.d.w - m.b.y * m.c.w * m.d.z - m.c.y * m.b.z * m.d.w + m.c.y * m.b.w * m.d.z +
              m.d.y * m.b.z * m.c.w - m.d.y * m.b.w * m.c.z;

    res.b.x = -m.b.x * m.c.z * m.d.w + m.b.x * m.c.w * m.d.z + m.c.x * m.b.z * m.d.w - m.c.x * m.b.w * m.d.z -
              m.d.x * m.b.z * m.c.w + m.d.x * m.b.w * m.c.z;

    res.c.x = m.b.x * m.c.y * m.d.w - m.b.x * m.c.w * m.d.y - m.c.x * m.b.y * m.d.w + m.c.x * m.b.w * m.d.y +
              m.d.x * m.b.y * m.c.w - m.d.x * m.b.w * m.c.y;

    res.d.x = -m.b.x * m.c.y * m.d.z + m.b.x * m.c.z * m.d.y + m.c.x * m.b.y * m.d.z - m.c.x * m.b.z * m.d.y -
              m.d.x * m.b.y * m.c.z + m.d.x * m.b.z * m.c.y;

    res.a.y = -m.a.y * m.c.z * m.d.w + m.a.y * m.c.w * m.d.z + m.c.y * m.a.z * m.d.w - m.c.y * m.a.w * m.d.z -
              m.d.y * m.a.z * m.c.w + m.d.y * m.a.w * m.c.z;

    res.b.y = m.a.x * m.c.z * m.d.w - m.a.x * m.c.w * m.d.z - m.c.x * m.a.z * m.d.w + m.c.x * m.a.w * m.d.z +
              m.d.x * m.a.z * m.c.w - m.d.x * m.a.w * m.c.z;

    res.c.y = -m.a.x * m.c.y * m.d.w + m.a.x * m.c.w * m.d.y + m.c.x * m.a.y * m.d.w - m.c.x * m.a.w * m.d.y -
              m.d.x * m.a.y * m.c.w + m.d.x * m.a.w * m.c.y;

    res.d.y = m.a.x * m.c.y * m.d.z - m.a.x * m.c.z * m.d.y - m.c.x * m.a.y * m.d.z + m.c.x * m.a.z * m.d.y +
              m.d.x * m.a.y * m.c.z - m.d.x * m.a.z * m.c.y;

    res.a.z = m.a.y * m.b.z * m.d.w - m.a.y * m.b.w * m.d.z - m.b.y * m.a.z * m.d.w + m.b.y * m.a.w * m.d.z +
              m.d.y * m.a.z * m.b.w - m.d.y * m.a.w * m.b.z;

    res.b.z = -m.a.x * m.b.z * m.d.w + m.a.x * m.b.w * m.d.z + m.b.x * m.a.z * m.d.w - m.b.x * m.a.w * m.d.z -
              m.d.x * m.a.z * m.b.w + m.d.x * m.a.w * m.b.z;

    res.c.z = m.a.x * m.b.y * m.d.w - m.a.x * m.b.w * m.d.y - m.b.x * m.a.y * m.d.w + m.b.x * m.a.w * m.d.y +
              m.d.x * m.a.y * m.b.w - m.d.x * m.a.w * m.b.y;

    res.d.z = -m.a.x * m.b.y * m.d.z + m.a.x * m.b.z * m.d.y + m.b.x * m.a.y * m.d.z - m.b.x * m.a.z * m.d.y -
              m.d.x * m.a.y * m.b.z + m.d.x * m.a.z * m.b.y;

    res.a.w = -m.a.y * m.b.z * m.c.w + m.a.y * m.b.w * m.c.z + m.b.y * m.a.z * m.c.w - m.b.y * m.a.w * m.c.z -
              m.c.y * m.a.z * m.b.w + m.c.y * m.a.w * m.b.z;

    res.b.w = m.a.x * m.b.z * m.c.w - m.a.x * m.b.w * m.c.z - m.b.x * m.a.z * m.c.w + m.b.x * m.a.w * m.c.z +
              m.c.x * m.a.z * m.b.w - m.c.x * m.a.w * m.b.z;

    res.c.w = -m.a.x * m.b.y * m.c.w + m.a.x * m.b.w * m.c.y + m.b.x * m.a.y * m.c.w - m.b.x * m.a.w * m.c.y -
              m.c.x * m.a.y * m.b.w + m.c.x * m.a.w * m.b.y;

    res.d.w = m.a.x * m.b.y * m.c.z - m.a.x * m.b.z * m.c.y - m.b.x * m.a.y * m.c.z + m.b.x * m.a.z * m.c.y +
              m.c.x * m.a.y * m.b.z - m.c.x * m.a.z * m.b.y;
