...
inline double3 abs(double3 v) {
    double4 e = bit_and(cast4(v), lbroad4(~SignBit64));
    return e.xyz;
}
...
inline void remove_dups(vector<double3>& vertices) {
    ::remove_dups(vertices, static_cast<bool (*)(double3, double3)>(&lex_less),
