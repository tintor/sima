...
class plane {
   public:
    ...
    plane(double3 normal, double d) : n(extend(normal, d)) {
    ...
    double distance(double3 p) const { return dot(n.xyz, p) + n.w; }
    ...
    static double sign(double3 a, double3 b, double3 c, double3 p) { return dot(cross(b - a, c - a), p - a); }
