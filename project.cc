...
segment2 Project(const segment3& s, int axis) {
	if (axis == 0)
		return segment2(double2{s.a.y, s.a.z}, double2{s.b.y, s.b.z});
	if (axis == 1)
		return segment2(double2{s.a.x, s.a.z}, double2{s.b.x, s.b.z});
	if (axis == 2)
		return segment2(double2{s.a.x, s.a.y}, double2{s.b.x, s.b.y});
