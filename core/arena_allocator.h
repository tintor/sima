...
class Arena {
public:
	static void* add(void* a, size_t b) {
		return reinterpret_cast<void*>(reinterpret_cast<size_t>(a) + b);
	}

	static void* sub(void* a, size_t b) {
		return reinterpret_cast<void*>(reinterpret_cast<size_t>(a) - b);
	}

	static size_t sub(void* a, void* b) {
...
public:
  ...
  pointer allocate(size_type n, const void * = 0) {
    return (T*) g_arena.allocate(n * sizeof(T));
  }
  ...
  template <class U>
  ArenaAllocator& operator=(const ArenaAllocator<U>&) { return *this; }
};
