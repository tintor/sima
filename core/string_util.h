...
inline bool search(string_view s, const regex& re) { return std::regex_search(s.begin(), s.end(), re); }

inline bool search(string_view s, const regex& re, std::cmatch& match) {
    return std::regex_search(s.begin(), s.end(), /*out*/ match, re);
}

inline bool match(string_view s, const regex& re) { return std::regex_match(s.begin(), s.end(), re); }
